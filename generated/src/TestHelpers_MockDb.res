...
@genType
and entities = {
    @as("RelayDepository_RelayErc20Deposit") relayDepository_RelayErc20Deposit: entityStoreOperations<Entities.RelayDepository_RelayErc20Deposit.t>,
    @as("RelayDepository_RelayNativeDeposit") relayDepository_RelayNativeDeposit: entityStoreOperations<Entities.RelayDepository_RelayNativeDeposit.t>,
  }
  ...
  let entities = {
      relayDepository_RelayErc20Deposit: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.RelayDepository_RelayErc20Deposit)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.RelayDepository_RelayErc20Deposit.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      relayDepository_RelayNativeDeposit: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.RelayDepository_RelayNativeDeposit)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.RelayDepository_RelayNativeDeposit.t,
            >
          ),
          ~getKey=({id}) => id,
        )
