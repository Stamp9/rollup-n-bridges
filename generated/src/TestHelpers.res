...
module RelayDepository = {
  module RelayErc20Deposit = {
    @genType
    let processEvent: EventFunctions.eventProcessor<Types.RelayDepository.RelayErc20Deposit.event> = EventFunctions.makeEventProcessor(
      ~register=(Types.RelayDepository.RelayErc20Deposit.register :> unit => Internal.eventConfig),
    )
...
->(Utils.magic: Types.RelayDepository.RelayErc20Deposit.eventArgs => Internal.eventParams)

      EventFunctions.makeEventMocker(
        ~params,
        ~mockEventData,
        ~register=(Types.RelayDepository.RelayErc20Deposit.register :> unit => Internal.eventConfig),
      )->(Utils.magic: Internal.event => Types.RelayDepository.RelayErc20Deposit.event)
    }
  }

  module RelayNativeDeposit = {
    @genType
    let processEvent: EventFunctions.eventProcessor<Types.RelayDepository.RelayNativeDeposit.event> = EventFunctions.makeEventProcessor(
      ~register=(Types.RelayDepository.RelayNativeDeposit.register :> unit => Internal.eventConfig),
    )
...
->(Utils.magic: Types.RelayDepository.RelayNativeDeposit.eventArgs => Internal.eventParams)

      EventFunctions.makeEventMocker(
        ~params,
        ~mockEventData,
        ~register=(Types.RelayDepository.RelayNativeDeposit.register :> unit => Internal.eventConfig),
      )->(Utils.magic: Internal.event => Types.RelayDepository.RelayNativeDeposit.event)
    }
  }
